...
$s1 = slider_value($dbc, 'f2-s1');
$a1 = slider_alt($dbc, 'f2-s1');
$u1 = slider_url($dbc, 'f2-s1');

$s2 = slider_value($dbc, 'f2-s2');
$a2 = slider_alt($dbc, 'f2-s2');
$u2 = slider_url($dbc, 'f2-s2');

$s3 = slider_value($dbc, 'f2-s3');
$a3 = slider_alt($dbc, 'f2-s3');
$u3 = slider_url($dbc, 'f2-s3');

$s4 = slider_value($dbc, 'f2-s4');
$a4 = slider_alt($dbc, 'f2-s4');
$u4 = slider_url($dbc, 'f2-s4');

$s5 = slider_value($dbc, 'f2-s5');
$a5 = slider_alt($dbc, 'f2-s5');
$u5 = slider_url($dbc, 'f2-s5');

$s6 = slider_value($dbc, 'f2-s6');
$a6 = slider_alt($dbc, 'f2-s6');
$u6 = slider_url($dbc, 'f2-s6');
